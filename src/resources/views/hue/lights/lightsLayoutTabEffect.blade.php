<form action="{{ route('hueLightsSetState.post') }}" method="post" id="setLightEffect{{ $i }}" name="setLightState">
    <div>
            ...
            <tbody>
                    ...
                    <td>
                        <div class="rowbox">
                            <div style="width: 80%;border:0px solid #000000;padding: 12px 10px 0 10px;">
                                <div id="transitiontimeSlider{{ $i }}" name="lightStateSlider" class="slider" data-slider data-step="1" data-initial-start="0" data-options="start: 0; end: 50;precision:null;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="rowbox">
                            <div style="width: 80%;border:0px solid #000000;padding: 12px 10px 0 10px;">
                                <div id="bri_incSlider{{ $i }}" name="lightStateSlider" class="slider" data-slider data-step="1" data-initial-start="0" data-options="{{ config('sh.hue.slider.bri_inc') }}precision:null;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="rowbox">
                            <div style="width: 80%;border:0px solid #000000;padding: 12px 10px 0 10px;">
                                <div id="sat_incSlider{{ $i }}" name="lightStateSlider" class="slider" data-slider data-step="1" data-initial-start="0" data-options="{{ config('sh.hue.slider.sat_inc') }}precision:null;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="rowbox">
                            <div style="width: 80%;border:0px solid #000000;padding: 12px 10px 0 10px;">
                                <div id="ct_incSlider{{ $i }}" name="lightStateSlider" class="slider" data-slider data-step="1" data-initial-start="0" data-options="{{ config('sh.hue.slider.ct_inc') }}precision:null;">
